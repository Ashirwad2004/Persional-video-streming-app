      ...
      <div className="flex flex-col items-center py-10">
        <div className="max-w-4xl w-full text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-indigo-700 mb-6">
            Your Personal Cloud Storage Streaming Platform
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            >
              <Video className="h-16 w-16 text-indigo-600 mb-4 transform transition-all duration-300 hover:scale-110 hover:text-indigo-800" />
            ...
            <Link 
              ...
              className="flex flex-col items-center p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
            >
              <Menu className="h-16 w-16 text-indigo-600 mb-4 transform transition-all duration-300 hover:scale-110 hover:text-indigo-800" />
