...
const supabaseUrl = process.env.VITE_SUPABASE_URL || 'https://dlqqzgtlrytmbjtacfuh.supabase.co';
const supabaseKey = process.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRscXF6Z3Rscnl0bWJqdGFjZnVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA3NTk4MTksImV4cCI6MjA1NjMzNTgxOX0.oMJ5iWTVrugM-GEO24ZU1FwfcHtUUydy5tNYNaskRxk';
